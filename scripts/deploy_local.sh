...
#   3. Anotar em documentacao/Historico.md
#   4. git commit
...
#     --resolve)
#   - Vhost OpenLiteSpeed dedicado provisionado (ver documentacao/deploy/
#     vhost_dashboard_oficialsport.conf) com os 3 ajustes de WebSocket
#     (enableSpdy 0, enableWebSocket 1, bloco websocket dedicado) — sem isso
#     o slideshow (Streamlit) fica preso em loading infinito atrás do proxy.
################################################################################
...
# ─── 2. Push para GitHub ─────────────────────────────────────────────────────
echo -e "${CYAN}▶ [1/4] Enviando para GitHub (origin/master)...${NC}"
